...
def check_binary_search_tree_(root,ma,mi):
    if root==None:
        return True
    if root.data>ma or root.data<mi:
        return False
    return check_binary_search_tree_(root.left,root.data-1,mi) and check_binary_search_tree_(root.right,ma,root.data+1)
